    ...
    return (
        <div className="flex justify-between items-start px-24 py-12 bg-black text-white h-screen box-border">
            ...
            <div className="flex-1 flex flex-col items-end gap-10 mr-60 mb-100 ">
                ...
                <div
                    ref={ref1}
                    className={`mt-[130px] mr-[200px] w-[350px] h-[350px] bg-gray-300 text-black p-[60px] rounded-full flex items-center justify-center text-[25px] font-normal text-center leading-[1.5] transition-transform transition-opacity duration-600 ${
                ...
                <div className="flex gap-12">
                    <div
                        ref={ref2}
                        className={`w-[350px] h-[350px] mt-7 bg-gray-600 text-white rounded-full p-[30px] flex items-center justify-center text-[23px] font-normal text-center leading-[1.5] transition-transform transition-opacity duration-600 ${
                    ...
                    <div
                        ref={ref3}
                        className={`w-[350px] h-[350px] mt-7 bg-white text-black rounded-full p-[30px] flex items-center justify-center text-[25px] font-normal text-center leading-[1.5] transition-transform transition-opacity duration-600 ${
